...
class Set_Pad_Clearance( pcbnew.ActionPlugin ):
    ...
    def defaults( self ):
        self.name = "Set global pad clearance (copper and solder mask)"
    ...
    def Run( self ):     
        class displayDialog(wx.Dialog):
            def __init__(self, parent):
                wx.Dialog.__init__(self, parent, id=-1, title="Set Pad Clearance", size=(450, 150))#
                ...
                l1 = wx.StaticText(self.panel, -1, "Global pad to copper clearance (mm):") 
                ...
                l2 = wx.StaticText(self.panel, -1, "Global solder mask clearance (mm):") 
            ...
            def OnKeyTyped2(self, event):
                self.pmargin = self.retanum(self.t2.GetValue(), 0)
        ...
        if frame.perform_changes:
            ...
            for p in pads:
                ...
                p.SetLocalSolderMaskMargin(pcbnew.FromMM(frame.pmargin))
